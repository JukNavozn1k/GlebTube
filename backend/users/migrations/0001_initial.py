    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, default='', max_length=1024, null=True, verbose_name='Описание')),
                ...
                ('user_embeddings', models.JSONField(blank=True, null=True, verbose_name='Кластеры эмбеддингов')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('subscriber', 'channel'), name='unique_users_sub')],
            },
        ),
    ]
