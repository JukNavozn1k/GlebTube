...
urlpatterns = [
  ...
  path('add_comment_video/<int:video_id>',views.ViewComments.as_view(),name='add_comment'),
  path('rm_comment/<int:comment_id>/',views.ViewComments.as_view(),name='delete_comment'),
